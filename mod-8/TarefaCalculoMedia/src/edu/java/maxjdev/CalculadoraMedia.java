...
/**
 * @author maxdev
 * Classe recebe 4 notas, getters e setters, metodo para somar 4 doubles e metodo para calcular media das notas
 */
public class CalculadoraMedia {
    /** * * * Atributos * * *
     * Notas foram definidas como final por não necessitarem de mudanças apos inicialização do construtor.
     * */
